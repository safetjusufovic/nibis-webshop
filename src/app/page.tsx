...
// ─── Footer ───────────────────────────────────────────────────────────────────
function Footer({ shopSlug = '' }: { shopSlug?: string }) {
  return <FooterComponent shopSlug={shopSlug} />
}
...
export function ShopPage({ shopSlug = '' }: { shopSlug?: string }) {
  ...
  const loadArtikli = useCallback(async () => {
    ...
    // shopSlug dolazi kao prop — ne čitamo iz URL-a
  ...
  return (
    <div className="min-h-screen" style={{ background: "var(--surface)" }}>
        ...
        <FooterComponent shopSlug={shopSlug} />
