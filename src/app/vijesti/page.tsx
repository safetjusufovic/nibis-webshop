  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--surface)' }}>
      ...
      <div style={{ maxWidth: '1100px', margin: '0 auto', padding: '48px 24px 80px' }}>
        ...
        {/* Istaknuti članak */}
        {istaknuti.length > 0 && (
          <Link href={'/vijesti/' + istaknuti[0].slug} style={{ textDecoration: 'none', display: 'block', marginBottom: '32px' }}>
        ...
        {ostali.length > 0 && (
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '20px' }}>
            {ostali.map(c => (
              <Link key={c.id} href={'/vijesti/' + c.slug} style={{ textDecoration: 'none' }}>
